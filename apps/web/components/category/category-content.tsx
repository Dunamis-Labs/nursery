...
export function CategoryContent({ categoryName, products, explainer }: CategoryContentProps) {
  ...
  // Calculate filtered product count (simplified - full filtering happens in ProductGrid)
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            />
            <ProductGrid products={products} filters={filters} sortBy={sortBy} />
          </div>
        </div>
      </div>
    </>
